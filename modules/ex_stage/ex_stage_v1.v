module ex_stage (
    ...
    assign alu_b = ex_alu_src ? ex_imm : alu_b_raw;
    ...
    // Pass-through to EX/MEM pipeline register
    always @(*) begin
    ...
    // Combinational logic for branch and jump resolution
    always @(*) begin
        if (is_jump) begin
    ...
    // Handle flush: invalidate control signals
    always @(*) begin
        if (flush) begin
            branch_taken = 1'b0;
            branch_target = 32'h0;
