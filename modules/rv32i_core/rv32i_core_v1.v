...
module rv32i_core (
    ...
    logic [4:0]  ex_rd_addr_out; // directly from ex_alu_result, but ex_stage has ex_alu_result output
    // ex_stage outputs ex_alu_result, ex_rd_addr, ex_mem_wdata, etc. – they are registered
    // but we'll use the same wire names as the stage outputs: ex_alu_result, ex_rd_addr_out, ex_mem_wdata, ex_mem_read, ex_mem_write, ex_funct3, ex_reg_write, ex_wb_sel, ex_valid.
    // We'll declare them explicitly:
    ...
    id_ex_reg u_id_ex_reg (
        ...
        .id_imm      (id_imm),
        .id_rd_addr  (id_rd_addr),
        .id_pc       (id_pc_out),   // id_pc_out is PC+4 (or PC) – passed through
        .id_alu_src  (id_alu_src),
        .id_alu_op   (id_alu_op),
        .id_mem_read (id_mem_read),
        .id_mem_write(id_mem_write),
    ...
    ex_stage u_ex_stage (
        ...
        .ex_rd_addr     (ex_rd_addr_out),   // ex_stage passes through rd_addr
