module control_unit (
    ...
    output wire        alu_src,     // ALU source select (0=rs2, 1=imm)
    ...
    output wire [1:0]  wb_sel,      // Write-back select (00=ALU, 01=MEM, 10=PC+4)
    output wire        branch,      // Branch instruction flag
    output wire        jump,        // JAL instruction flag
    output wire        jr,          // JALR instruction flag
    output wire        is_load,     // Is load instruction flag
    output wire        is_store,    // Is store instruction flag
